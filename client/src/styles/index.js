const styles = {
  // general
  headText: 'font-libreBaskerville font-bold text-white sm:text-6xl text-4xl',
  normalText: 'font-montserrat font-normal text-[24px] text-siteWhite',
  footerText: 'font-montserrat font-medium text-base text-white',
  infoText: 'font-montserrat font-medium text-lg text-siteViolet cursor-pointer',
  ...
  // join room page
  joinHeadText: 'font-libreBaskerville font-semibold text-2xl text-white mb-3',
  joinContainer: 'flex flex-col gap-3 mt-3 mb-5',
  joinRoomTitle: 'font-montserrat font-normal text-xl text-white',
  joinLoading: 'font-montserrat font-normal text-xl text-white',
  ...
  levelsCardText: 'font-montserrat font-semibold text-2xl text-white',
  ...
  playerMana: 'w-14 h-14 rounded-full text-white font-montserrat font-extrabold text-2xl cursor-pointer',
  playerInfo: 'font-montserrat font-medium',
  ...
  cardPoint: 'font-montserrat text-[20px] font-bold',
  cardTextContainer: 'absolute w-full bottom-[13.5%] left-3',
  cardText: 'font-montserrat text-[26px] font-bold text-white',

  // custom button component
  btn: 'px-4 py-2 rounded-lg bg-siteViolet w-fit text-white font-montserrat font-bold',

  // custom input component
  label: 'font-montserrat font-semibold text-2xl text-white mb-3',
  ...
  gameLoadText: 'font-montserrat text-siteWhite text-2xl mt-5 text-center',
  ...
  gameLoadPlayerText: 'mt-3 font-montserrat text-white md:text-xl text-base',
  gameLoadVS: 'font-montserrat font-extrabold text-siteViolet text-7xl mx-16',
  ...
  gameInfoSidebarClose: 'w-10 h-10 rounded-md bg-siteViolet text-white font-montserrat font-extrabold text-xl cursor-pointer',
  gameInfoHeading: 'font-libreBaskerville font-bold text-white text-3xl',
  gameInfoText: 'font-montserrat font-medium text-white text-xl mb-2',
  ...
  alertWrapper: 'p-4 rounded-lg font-montserrat font-semibold text-lg ',
  alertIcon: 'flex-shrink-0 inline w-6 h-6 mr-2',

  // modal
  modalText: 'font-montserrat font-bold text-3xl text-white mb-6 text-center',
};
